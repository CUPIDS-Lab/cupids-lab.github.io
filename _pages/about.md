...
nav: about
eyebrow: About
title: "Why CUPIDS exists."
summary: "A public-interest data science lab built on a hard observation: the public data democracy depends on is being deleted and restricted — while the watchdogs who depend on it are hollowed out at the same time."
description: "About CUPIDS Lab — the University of Colorado Public Interest Data Science Laboratory: our mission, values, and motivation, and the COLUMN Lab that came before."
---
...
{% include components/moment.html %}
...
- **We build capacity.** Through a pro-bono [help desk](/get-involved/#request-help), we give Colorado's journalists, lawyers, and nonprofits the technical help they can't otherwise afford: pulling data out of documents, recovering deleted records, merging messy sources, fact-checking analyses, and making findings legible.
...
- **Openness and auditability.** Our methods, our code, and this website are [open source](https://github.com/CUPIDS-Lab), so our claims can be checked rather than taken on faith.
- **Source protection.** Protecting the people who bring us data is a design requirement, not a footnote — we minimize what we collect, keep sensitive channels off institutional systems, and [don't unmask sources](/policies/).
...
CUPIDS did not start from nothing. Its direct predecessor is [**COLUMN** — the Colorado Laboratory for Users, Media, and Networks](https://columnlab.github.io/), founded by Brian Keegan in CU Boulder's Department of Information Science. COLUMN's work was computational social science: using the digital traces left on Wikipedia, Reddit, and Twitter to understand how people collaborate, how attention moves, and how online communities form and fracture around current events, controversies, and disasters.
...
{% include components/cta.html title="Defend the data democracy depends on." text="Request help from the desk, join a student team, partner with us, or fund the work — start on the Get Involved page." label="Get involved →" to="/get-involved/" %}
